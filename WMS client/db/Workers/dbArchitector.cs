...
namespace WMS_client.db
    ...
    public static class dbArchitector
        ...
        public static void CreateMapTable()
            {
            using (SqlCeCommand query = dbWorker.NewQuery(@"CREATE TABLE Maps(
Id bigint not null,
...
RegisterTo int not null)"))
        ...
        public static void ClearAllDataFromTable<T>() where T : dbObject
            ...
            using (SqlCeCommand query = dbWorker.NewQuery(string.Concat(@"DELETE FROM ", tableName)))
                {
                query.ExecuteNonQuery();
                }
            }
        ...
        public static void ClearAll()
            ...
            ClearAllDataFromTable(typeof(AcceptanceOfNewComponentsDetails).Name);
            //Відправка на ...
