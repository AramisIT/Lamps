...
namespace WMS_client
    ...
    public class ValueEditor : BusinessProcess
        ...
        public ValueEditor(PropertyButtonInfo propertyInfo, AccessoriesSet accessoriesSet)
            : base( 1)
            {
        ...
        private void button_Click()
            ...
            if (setAccessoryValue(value))
                ...
                MainProcess.Process = new AccessoryRegistration(accessoriesSet);
                }
            else
                {
                "Невірний формат даних!".ShowMessage();
                }
            }
